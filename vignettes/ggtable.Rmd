...
The `cells` argument allows you to control what to dispay. For proportions of the total, row proportions or columns proportions, simply use `"prop"`, `"row.prop"` or `"col.prop"`.
...
To fill cells with standradized residuals, simply indicate `fill = "stdres"`.
