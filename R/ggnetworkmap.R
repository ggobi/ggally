...
#' us %>% ggnetworkmap(graph, size = 2, great.circles = TRUE, node.group = mygroup,
#' 										ring.group = degree,
#' 										segment.color = "cornflowerblue", weight.method = "none")
